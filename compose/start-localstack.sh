...
function is_ready() {
    ...
    aws --endpoint-url=http://sqs.eu-west-2.localhost.localstack.cloud:4566 sns list-topics --query "Topics[?ends_with(TopicArn, ':trade_imports_activities')].TopicArn" || return 1
