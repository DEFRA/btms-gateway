...
public class DifferentMessageTypesOnSameRouteTests
{
    ...
    {
        var messageRoutes = new MessageRoutes(TestRoutes.DifferentMessageTypesOnSameRoutingConfig, Substitute.For<ILogger>());
        ...
        route.FullForkLink.Should().Be("btms-link-1-queue");
    }
