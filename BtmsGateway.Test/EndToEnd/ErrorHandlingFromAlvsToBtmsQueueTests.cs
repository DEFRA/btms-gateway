...
public class ErrorHandlingFromAlvsToBtmsQueueTests(ITestOutputHelper testOutputHelper)
    : QueueRoutingTestBase(testOutputHelper, "alvs_error_fork.fifo", "alvs_error_route.fifo")
{
